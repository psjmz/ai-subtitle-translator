...
(function (root, factory) {
  ...
  const INK_RATIO = {
    ...
    'km': 0.660, 'lo': 0.531,
    /* v0.9.112 新增：同法实测（校验组 th 0.577/hi 0.649/te 0.771/my 0.556/lo 0.532/he 0.524 均复现既有值）。
       as 与 bn 同孟加拉文、ps/ku 与 ar 同阿拉伯字母，直接沿用 bn/ar 实测值。*/
    'gu': 0.594, 'kn': 0.797, 'ml': 0.524, 'pa': 0.584, 'or': 0.677, 'as': 0.657, 'am': 0.852, 'ps': 0.610, 'ku': 0.610,
    _default: 0.545   // 拉丁 / 西里尔等半高书写系统（en fr de es pt it ru uk sr bg id tr pl nl ms fil sv da fi nb cs sk hu ro ca hr sw）
                      // v0.9.112 新增的 kk uz mn az is et lv lt sl sq mk eu gl ha yo zu so af 实测亦为 0.545，不单列
  };
  ...
  const REC_ASS_SIZE = {
    ...
    // v0.9.112 新增：均由 size = even(40.992 / INK_RATIO) 算出；拉丁/西里尔 76、ps/ku 同 ar 68、as 同 bn 62
    'gu': 70, 'kn': 52, 'ml': 78, 'pa': 70, 'or': 60, 'as': 62, 'kk': 76, 'uz': 76, 'mn': 76, 'az': 76, 'is': 76, 'et': 76, 'lv': 76, 'lt': 76, 'sl': 76, 'sq': 76, 'mk': 76, 'eu': 76, 'gl': 76, 'am': 48, 'ha': 76, 'yo': 76, 'zu': 76, 'so': 76, 'ps': 68, 'ku': 68, 'af': 76,
  };
  ...
  const INK_DESC = {         // baseline 下方的墨迹深度（/em）：拉丁 g/y/p/q 有下伸，汉字几乎没有
    ...
    /* v0.9.112 新增：baseline 下方墨迹深度（p90）：gu/pa/or 几乎不下探，
       kn 下伸 0.144，as 与 bn 同孟加拉文 0.16；ml 0.181 / am 0.184 与默认 0.21 差异小，不单列。*/
    'gu': 0.01, 'pa': 0.062, 'or': 0.042, 'kn': 0.144, 'as': 0.16,
    _default: 0.21
  };
